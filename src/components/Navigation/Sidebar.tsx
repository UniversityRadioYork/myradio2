		...
		<div className={"myr-sidebar bp3-elevation-2"}>
			<Card elevation={1}>
				...
				<Menu>
					...
					{!!user && <Menu.Item text={`Signed in as ${user.fname} ${user.sname}`} />}
					...
					<NavItem
						path="/scheduler/newShow"
						text="Apply for new Show"
					/>
					<NavItem path="/Scheduler/shows" text="This Term's Shows" />
					<NavItem
						path="/Scheduler/shows?all=true"
						text="All Shows"
					/>
					...
					/>
					<NavItem
						path="/Podcast/editPodcast"
						text="Upload a New Podcast"
					/>
					...
					<NavItem
						path="/Library/addTrack"
						text="Upload a New Track"
					/>
					<NavItem
						path="/iTones/listPlaylists"
						text="Edit Playlists"
					/>
					<NavItem
